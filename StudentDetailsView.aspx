<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentDetailsView.aspx.cs" Inherits="StudentDetailsView" %>
...
<%--<body style="background-image: url('blur3.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">--%>
<body>
    <form id="form1" runat="server" style="width: 70%; margin-left: 15%; margin-top: 5%; margin-bottom: 5%;">
        ...
        <div>
            ...
            <div><asp:Button ID="btnEditPDetails" runat="server" Text="Edit Personal Details" CssClass="btn-success" style="margin-right:5%;" OnClick="btnEditPDetails_Click"/></div>
            </center>
        </div>
        <br />
        ...
        <br />
        <center><div>
            <asp:Button ID="btnEditADetails" runat="server" Text="Edit Academic Details" CssClass="btn-success" style="margin-right:5%;" OnClick="btnEditADetails_Click"/>
        </div></center>
        <div class="navbar"></div>
    </form>
</body>
