...
public partial class StudentDetailsView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else { Response.Write("No data present for this Roll No. Enter/Edit your Details."); }
            sqlcon.Close();

            //Academic Details
            sqlcon = new SqlConnection(ConfigurationManager.ConnectionStrings["SQLConnectionString"].ConnectionString);
            sqlcon.Open();
            sqlcmd2 = new SqlCommand("select * from StudentDetailsAcademic where RollNo='" + Session["RollNo"] + "'", sqlcon);
    ...
    protected void btnEditPDetails_Click(object sender, EventArgs e)
    {
        Response.Redirect("StudentDetailsEdit.aspx");
    }
    ...
    protected void btnEditADetails_Click(object sender, EventArgs e)
    {
        Response.Redirect("StudentAcademicEdit.aspx");
    }
}