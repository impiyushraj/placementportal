...
<head runat="server">
    ...
    <style>
        .jumbotron {margin-left: 100px; background-image: url(assets/images/tnpcover.png); background-size:auto; background-repeat:no-repeat; width:1000px; height: 200px;}
    </style>
</head>
<body style="background-color:lemonchiffon;">
    ...
    <div class="jumbotron">
        <%--<img src="assets/images/tnpcover.png"; style="background-size:cover; height:200px; width:1000px"/>--%>
    </div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="assets/images/akg1.jpg" alt="First slide">
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p>
                                Note: If you're viewing this page via a <code>file://</code>URL, the "next" and "previous" Glyphicon buttons on the left and right might not load/display properly due
                                to web browser security rules.
                            </p>
                            <p>
                ...
                <div class="item">
                    <img src="assets/images/akg2.jpg" alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption">
                            <!--<h1>
                ...
                <div class="item">
                    <img src="assets/images/akg3.jpg" alt="Third slide">
                    <div class="container">
                        <div class="carousel-caption">
                            <!--<h1>
            ...
            </div><a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev"><span class="fa fa-chevron-left glyphicon glyphicon-chevron-left"></span></a> <a class=
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p>
                        Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum
                ...
                <div class="col-lg-6">
                    ...
                    <p>
                        Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac
            ...
            <div class="row featurette">
                <div class="col-md-7">
                    ...
                    <p class="lead">
                        Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce
